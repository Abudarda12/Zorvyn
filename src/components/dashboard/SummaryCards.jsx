...
const SummaryCards = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-10">
      {/* Total Balance - Zorvyn Gold Style */}
      <div className="bg-gradient-to-br from-[#1c1c1c] to-[#111111] border border-[#d49a6a]/20 rounded-[28px] p-5 md:p-7 shadow-[0_8px_40px_rgb(0,0,0,0.4)] relative overflow-hidden group hover:border-[#d49a6a]/50 transition-colors duration-500">
      ...
      {/* Income */}
      <div className="bg-[#111111] border border-[#1e1e1e] hover:border-[#2a2a2a] transition-colors rounded-[28px] p-5 md:p-7 shadow-2xl flex flex-col justify-between">
        <div className="flex items-center space-x-4 mb-4">
