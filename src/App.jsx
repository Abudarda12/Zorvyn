  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="col-span-1 xl:col-span-2 flex flex-col space-y-6 md:space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="bg-[#111111] rounded-[32px] p-5 md:p-8 shadow-2xl border border-[#1e1e1e]">
             ...
             <div className="bg-[#111111] rounded-[32px] p-5 md:p-8 shadow-2xl border border-[#1e1e1e] flex flex-col justify-between">
              <div>
          ...
          <div className="bg-[#111111] rounded-[32px] p-5 md:p-8 shadow-2xl border border-[#1e1e1e] flex-1">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-8 border-b border-[#1e1e1e] pb-4 gap-2">
              <div>
