...
const MOCK_FALLBACK_DATA = [
  { id: 'tx-1', date: new Date(Date.now() - 86400000 * 5).toISOString(), category: 'Salary', amount: 8500, description: 'Monthly Salary', type: 'income' },
  { id: 'tx-2', date: new Date(Date.now() - 86400000 * 4).toISOString(), category: 'Food', amount: 145.5, description: 'Client Dinner', type: 'expense' },
  { id: 'tx-3', date: new Date(Date.now() - 86400000 * 2).toISOString(), category: 'Utilities', amount: 150, description: 'Electricity Bill', type: 'expense' },
  { id: 'tx-4', date: new Date(Date.now() - 86400000 * 1).toISOString(), category: 'Entertainment', amount: 320, description: 'Team Eventing', type: 'expense' },
  { id: 'tx-5', date: new Date().toISOString(), category: 'Food', amount: 25.5, description: 'Coffee Run', type: 'expense' },
];
...
export const useTransactionStore = create((set, get) => ({
  ...
  fetchTransactions: async () => {
    ...
    try {
      ...
      set({ 
        transactions: MOCK_FALLBACK_DATA, 
        isLoading: false, 
        isUsingMock: true,
      });
    }
